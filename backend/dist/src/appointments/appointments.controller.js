...
__decorate([
    (0, common_1.Get)('api/v1/departments/:departmentId/slots'),
...
__decorate([
    (0, common_1.Post)('api/v1/appointments'),
...
__decorate([
    (0, common_1.Patch)('api/v1/admin/appointments/:appointmentId/status'),
